...
import data_utils.data_transforms

from enum import Enum, unique
from tqdm import tqdm

from data_utils.io import IO
...
def collate_fn(batch):
    '''
    returns a list of tuples from each sample in the batch
    '''
    taxonomy_ids = []
    model_ids = []
    data = {}
...
class ShapeNetDataLoader(object):
    ...
    def _get_transforms(self, cfg, subset):
        if subset == DatasetSubset.TRAIN:
            return data_utils.data_transforms.Compose([{
